...
class SomeoneElseChatScreen extends StatefulWidget {
  final String firstName;
  const SomeoneElseChatScreen({super.key, required this.firstName});


  @override
  State<SomeoneElseChatScreen> createState() => _SomeoneElseChatScreenState();
}

class _SomeoneElseChatScreenState extends State<SomeoneElseChatScreen> {
