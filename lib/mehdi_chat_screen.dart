...
class MehdiChatScreen extends StatefulWidget {
  final String firstName;
  const MehdiChatScreen({super.key, required this.firstName});

  @override
  State<MehdiChatScreen> createState() => _MehdiChatScreenState();
}

class _MehdiChatScreenState extends State<MehdiChatScreen> {
  void _logout() {
  ...
  void _feedback() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
          builder: (context) => FeedbackPage(firstName: widget.firstName)),
    );
  }
...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  void initState() {
    ...
    _chat = _model.startChat(
        ...
        history: [
          Content.text(
              """I'm going to assign you a Borough of Manhattan Community College's current students. His name is Mehdi, His major is Computer Science. His physics professor is Mahmoud Ardebili. If we asks you that he doesn't know what to do for the next semester, tell him that you can be a physics SI Leader and that he should ask his professor about it. Also, there are research opportunities available in bmcc. Help him with that too, if he asks!
